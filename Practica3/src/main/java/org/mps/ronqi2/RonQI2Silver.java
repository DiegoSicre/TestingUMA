...
public class RonQI2Silver extends RonQI2{
    ...
    */
    public void obtenerNuevaLectura(){
        ...
        lecturasS.add(disp.leerSensorSonido()); //Esto estaba mal, no se estaba guardando la lectura de sonido
    ...
    */
    ...
    public boolean evaluarApneaSuenyo() {
        ...
        if(avgP>=thresholdP && avgS >=thresholdS){ //Aquí se ha hecho que la lógica de los thresHold coincida en ambos casos
            resultado = true; // Aqui no se evaluaba bien 
        }   
        else{
            resultado = false; // Lo mismo
        }
        return resultado;
    }
